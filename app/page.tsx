  ...
  return (
    <div className="min-h-screen selection:bg-emerald-500/30 font-sans overflow-hidden">
      ...
      <section className="flex flex-col items-center justify-center pt-16 pb-20 px-4 text-center">
        ...
        >
          <button className="flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-500 text-white px-8 py-4 rounded-full font-bold text-lg transition-all shadow-lg shadow-emerald-900/20 hover:scale-105 active:scale-95">
            <Download size={20} />
            Download APK
          </button>
          <a
